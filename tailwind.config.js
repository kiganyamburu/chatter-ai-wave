  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "wave-primary": "hsl(var(--wave-primary))",
        "wave-secondary": "hsl(var(--wave-secondary))",
        "wave-tertiary": "hsl(var(--wave-tertiary))",
        primary: {
        ...
        message: {
          ...
          "user-text": "hsl(var(--message-user-text))",
          "ai-text": "hsl(var(--message-ai-text))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 5px hsl(var(--wave-primary))" },
          "50%": {
            boxShadow:
              "0 0 20px hsl(var(--wave-primary)), 0 0 30px hsl(var(--wave-primary))",
          },
        },
      },
      animation: {
